...
class wechatCallbackapiTest
{
    ...
    private function receiveEvent($object)
    {
        ...
        {
            case "subscribe":
                $content = "欢迎关注微信账户，请点击下面链接绑定账户以为您便提供更多服务 "."<a href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf7000e880d5563bf&redirect_uri=http://dlwebs99.jd-app.com/good.php&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect' >绑定账户</a>";
    ...
    private function receiveImage($object)
    {
       $content = array("MediaId"=>$object->MediaId);
	    ...
	    $wcHelper->inserPic($fromuser,$picurl);
		  $content = array();
        $content[] = array("Title"=>"图片上传成功",  "Description"=>"图片上传成功，接下来可以打印此图片", "PicUrl"=>$picurl, "Url" =>"http://print.wx.dlwebs.com/zoom.php?id=".$fromuser."&pic=".$picurl);
